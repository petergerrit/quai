...
# Generates the binary icosahedral group BI.
...
phi = (1+sqrt(5))/2
gen = [e, i, j, 0.5*(e+i+j+k), (i+j/phi+phi*k)/2]
...
print(f"\nSaving {len(els)} matrices of shape {matrices_array.shape} to BI.npy")
save('BI.npy', matrices_array)
