...
$\Sigma+\HV{1}{1}{0}$ Campbell, $\Sigma+\HV{1}{2}{0}$ Eq.~(27) & \texttt{Z[$\omega_9$]} & \textsc{partial}: qutrit triorthogonal $[[9m\!-\!k,k,2]]_3$ distills Howard--Vala magic state; $\Sigma$-series transversal pairing unestablished & \cite{Campbell:2012jna} \\
